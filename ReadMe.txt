# Hack to Hire 2024 - Use Case For Data Scientist
...
## Usage
1. Open and run the Google Colab notebook to preprocess the data and train the model.
...
2. All contributors and third-party libraries used.
